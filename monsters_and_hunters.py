...
"""
variables are used to minimise typo errors
"""
DESC = 'desc'
NORTH = 'north'
SOUTH = 'south'
...
game world. The key is a string (i.e. 'Central City') that is the reference
...
worldRooms = {
    'Central City': {
        DESC: 'The Central City is a large open space with a fountain in the center. Streets lead in all directions.',
        NORTH: '23rd Street',
        EAST: '36th Street',
        SOUTH: '84th Street',
        WEST: '32nd Street',
    ...
    '23rd Street': {
        DESC: 'The northern end of 23rd Street has really gone down hill. Pot holes are everywhere, as are windingos, vampires, and warewolves.',
        WEST: 'Moon City',
        EAST: 'Bobbys Diner',
        SOUTH: 'Central City',
        GROUND: ['Do Not Take Sign Sign']},
    'Moon City': {
        DESC: 'The Moon City is a dark den of unprincipled freaks. You clutch your weapons close (an attck might come out of the darkness).',
        SOUTH: '32nd Street',
        EAST: '23rd Street',
        GROUND: ['Lock Picks', 'Holy water']},
    'Bobbys Diner': {
        DESC: 'The delightful smell of Burgers fills the air, making you hungry. The cook flashes a grin, as he slides a box marked "Not Human Organs" under a table with his foot.',
        WEST: '23rd Street',
        SOUTH: '36th Street',
        SHOP: ['Burgers', 'Pie', 'Beer'],
        GROUND: ['Shop Howto']},
    '32nd Street': {
        DESC: '32nd Street is the rich section of town. So rich, they paved the streets with gold. This probably was not a good idea. The Moon City opened up the next day.',
        NORTH: 'Moon City',
        EAST: 'Central City',
        SOUTH: 'Blacksmith',
        WEST: ' Midas Tavern',
        GROUND: []},
    ' Midas Tavern': {
        DESC: 'The blade store has blades of all types and sizes, each previously-owned but still in servicable condition. However, due to a bug in the way this game is designed, you can buy blades like any other item and walk around, but if you drop them they cannot be picked up since their TAKEABLE value is set to False. The code should be changed so that it\'s not possible for shops to sell items with TAKEABLE set to False.',
        EAST: '32nd Street',
        SHOP: ['blade'],
        GROUND: ['blade', 'dagger', 'silver', 'blade']},
    '36th Street': {
        DESC: '36th Street. It\'s like X Street, except East.',
        NORTH: 'Bobbys Diner',
        WEST: 'Central City',
        SOUTH: 'Bobbys Junkyard',
        GROUND: []},
    'Blacksmith': {
        DESC: 'The blacksmith loudly hammers a new sword over her anvil. Swords, axes, machete all line the walls of her workshop, available for a price.',
        NORTH: '32nd Street',
        EAST: '84th Street',
        SHOP: ['Sword', 'War Axe', 'Chainmail T-Shirt', 'machete'],
        GROUND: ['blade', 'Shop Howto']},
    '84th Street': {
        DESC: 'The Christmas Carolers of 84th Street are famous for all legally changing their name to Carol. They are also famous for singing year-round, in heavy fur coats and wool mittens, even in the summer. That\'s dedication to their craft!',
        NORTH: 'Central City',
        WEST: 'Blacksmith',
        GROUND: []},
    'Bobbys Junkyard': {
        DESC: 'Zanny magical antics are afoot in the world-famous Bobbys Junkyard. Cauldrons bubble, ghosts talk, and books float midair in this center of magical discovery.',
        NORTH: '36th Street',
        UP: 'The Bunker',
        GROUND: ['Crystal Ball', 'Floating Book', 'Floating Book']},
    'The Bunker': {
        DESC: 'You can see the entire town from the top of the Bobbys Junkyard!',
        DOWN: 'Bobbys Junkyard',
        UP: 'Magical Escalator to teachers',
        GROUND: ['Telescope']},
    'Magical Escalator to teachers': {
        DESC: 'Climb the escalator to reach the teachers and learn new skills.',
        UP: 'Magical Escalator to teachers',
        DOWN: 'The Bunker',
        GROUND: []},
    }
...
worldItems = {
    'Welcome Sign': {
        ...
        LONGDESC: 'The welcome sign reads, "Welcome to this Monsters and hunters. You can type "help" for a list of commands to use. Be sure to check out Al\'s cool programming books at http://inventwithpython.com"',
        TAKEABLE: False,
    ...
    'blade': {
        GROUNDDESC: 'The blacksmith\'s blade, far too heavy to pick up, rests in the corner.',
        SHORTDESC: 'an blade',
        LONGDESC: 'The black blade has the word "ACME" engraved on the side.',
        TAKEABLE: False,
        DESCWORDS: ['blade']},
    'Lock Picks': {
    ...
    'Burgers': {
        GROUNDDESC: 'A suspicious Burgers rests on the ground.',
        SHORTDESC: 'a Burger',
        LONGDESC: 'A Burger. Its the best burger in town.',
        EDIBLE: True,
        DESCWORDS: ['burger']},
    'Beer': {
        GROUNDDESC: 'A Beer rests on the ground. (Gross.)',
        SHORTDESC: 'a Beer',
        LONGDESC: 'It is a bottle of Beer.',
        EDIBLE: True,
        DESCWORDS: ['beer']},
    'Pie': {
        GROUNDDESC: 'A Pie rests on the ground. (Gross.)',
        SHORTDESC: 'a Pie',
        LONGDESC: 'It is an apple Pie.',
        EDIBLE: True,
        DESCWORDS: ['pie']},
    'Crystal Ball': {
    ...
    'README Note': {
        ...
        LONGDESC: 'The README note reads, "Welcome to the Monsters and hunters."',
        EDIBLE: True,
...
variable.
"""
location = 'Central City' # start in Central City
inventory = ['README Note', 'Sword', 'Holy water'] # start with blank inventory
showFullExits = True
